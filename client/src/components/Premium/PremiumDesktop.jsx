...
const PremiumDesktop = () => (
    <div className="">
        <div className="px-5 py-5 text-center header-bg">
            <img
                className="w-auto h-20 pb-4"
                src="/images/NinjaPrep-Logo.png"
                alt="logo"
            />
            <h2 className="display-5 px-5 pb-2">
                Learn, practice, and apply in-demand skills with a NinjaPrep
                subscription.
            </h2>
        ...
        <div className="py-5">
            <h2 className="display-5 px-5 pb-5 font-weight-bold text-center">
                Our Plans
            </h2>
            <CardDeck>
                <Card>
                    ...
                    <Card.Body>
                        <Card.Text>
                            Access to guided and convenient features, all in one
                            platform.
                        </Card.Text>
                    </Card.Body>
